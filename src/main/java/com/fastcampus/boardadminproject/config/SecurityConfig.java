package com.fastcampus.boardadminproject.config;

import com.fastcampus.boardadminproject.domain.constant.*;
import com.fastcampus.boardadminproject.dto.security.*;
...
public class SecurityConfig {
     ...
     *
     * @param adminAccountService 게시판 서비스의 어드민 계정을 다루는 서비스 로직
                    ...
                    .orElseGet(() ->
                            BoardAdminPrincipal.from(
                                    adminAccountService.saveUser(
                                            ...
                                            kakaoResponse.kakaoAccount().nickname(),
                                            null
                                    )
                            )
                    );
